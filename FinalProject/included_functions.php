...
<?php
	...
	function new_header($name="Logan Parker", $urlLink="") {
		echo "<head>";
		...
		echo "<li class='name'>";
		echo "  <h1 align='left'><a href='/~lsparker/FinalProject/home.php".$urlLink."'>$name</a></h1>";
		echo "</li>";
		echo "</ul>";
		echo "</nav>";
		echo "</div>";
	...
	function new_footer($footer){
		$name = "Logan Parker";
		date_default_timezone_set("America/Chicago");
		echo "<br /><br /><br />";
	    echo "<h4><div class='text-center'><small>Copyright {$name} ".date("M Y").", ".$footer."</small></div></h4>";
		echo "</body>";
		echo "</html>";
	}
